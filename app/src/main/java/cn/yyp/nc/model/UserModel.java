...
import cn.yyp.nc.model.i.QueryUserListener;
import cn.yyp.nc.model.i.UpdateCacheListener;
...
public class UserModel extends BaseModel {
     ...
     * @param listener
     */
    public void queryUsers(final String username, final int limit, final FindListener<User> listener) {
            ...
            public void done(List<User> list, BmobException e) {
                ...
                if (e == null) {
                    if (list != null && list.size() > 0) {
                        ...
                        listener.done(users, e);
                    } else {
                        listener.done(users, new BmobException(CODE_NULL, "查无此人"));
                    }
                } else {
                    listener.done(users, e);
                }
